...
"""
# Code leveredged from https://github.com/yairf11/MUPPET/blob/master/hotpot/scripts/retriever/build_db.py
import argparse
import bz2
import sqlite3
import json
...
# import tfidf_retriever.utils as utils
# from tfidf_retriever.utils import serialize_object
...
def deserialize_object(encoded_obj):
    return json.loads(base64.b64decode(encoded_obj))

def serialize_object(obj):
    # serialize object into a string, and then encode in SQL-safe base64 format
